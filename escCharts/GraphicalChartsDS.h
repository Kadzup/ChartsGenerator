...
namespace GraphicalCharts
{
	...
	*/
    ...
    void GraphicalCharts::Charts::ShowXY(const bool& show = true)
    {
        if (show)
        {
            RGBColor lineColor;
    ...
    void GraphicalCharts::Charts::ShowFrame(const bool& show = true)
    {
        if (isVisible != show)
            isVisible = !isVisible;
    ...
    void GraphicalCharts::Charts::ShowFrameCorners(const bool& show = true)
    {
        if (show)
        {
            RGBColor outlineColor;
    ...
    void GraphicalCharts::Charts::DrawTower(const Point& Top, const int64_t& containerWidth, int64_t spacing = 5)
    {
    ...
    void GraphicalCharts::Charts::DrawTowerChart(const std::vector<DataNode>& data_nodes)
    {
        if (data_nodes.empty())
            return;
    ...
    void GraphicalCharts::Charts::DrawLineChart(const std::vector<DataNode>& data_nodes) {
        if (data_nodes.empty())
            return;
    ...
    void GraphicalCharts::Charts::DrawRectangleByLines(const Point& TopLeft, const Point& BottomRight, const RGBColor& outlineColor) {
    ...
    void GraphicalCharts::Charts::DrawCircleSelection(const Point& Center, const uint64_t& radius, const double& angleBegin, const double& angleEnd, const RGBColor& fillColor)
    {
    ...
    void GraphicalCharts::Charts::DrawPieChart(const std::vector<DataNode>& data_nodes)
    {
        if (data_nodes.empty())
            return;
    ...
    void GraphicalCharts::Frame::InitFrame()
    {
